...
import { ChannelGroupReference, ChannelPolicyReference, ChannelReference, IChannelGroupRef, IChannelPolicyRef, IChannelRef, IOriginEndpointPolicyRef, IOriginEndpointRef, OriginEndpointPolicyReference, OriginEndpointReference } from "../../interfaces/generated/aws-mediapackagev2-interfaces.generated";
/**
...
export declare class CfnChannelGroup extends cdk.CfnResource implements cdk.IInspectable, IChannelGroupRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnChannelGroup(x: any): x is CfnChannelGroup;
    static arnForChannelGroup(resource: IChannelGroupRef): string;
    /**
...
export declare class CfnOriginEndpoint extends cdk.CfnResource implements cdk.IInspectable, IOriginEndpointRef, cdk.ITaggableV2 {
     ...
     */
    readonly attrMssManifestUrls: Array<string>;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    mssManifests?: Array<cdk.IResolvable | CfnOriginEndpoint.MssManifestConfigurationProperty> | cdk.IResolvable;
    /**
...
export interface CfnOriginEndpointProps {
     ...
     */
    readonly mssManifests?: Array<cdk.IResolvable | CfnOriginEndpoint.MssManifestConfigurationProperty> | cdk.IResolvable;
    /**
     * The name of the origin endpoint associated with the origin endpoint configuration.
     *
...
export declare class CfnOriginEndpointPolicy extends cdk.CfnResource implements cdk.IInspectable, IOriginEndpointPolicyRef {
     ...
     */
    static isCfnOriginEndpointPolicy(x: any): x is CfnOriginEndpointPolicy;
    /**
...
export type { IChannelRef, ChannelReference };
export type { IChannelGroupRef, ChannelGroupReference };
export type { IChannelPolicyRef, ChannelPolicyReference };
export type { IOriginEndpointRef, OriginEndpointReference };
export type { IOriginEndpointPolicyRef, OriginEndpointPolicyReference };
