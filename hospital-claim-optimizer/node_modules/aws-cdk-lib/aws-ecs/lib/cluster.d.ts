...
import { IClusterRef, ClusterReference } from './ecs.generated';
...
import { Duration, IResource, Resource, Size } from '../../core';
/**
...
export declare class Cluster extends Resource implements ICluster {
     ...
     */
    private _clusterScopedCapacityProviderNames;
    /**
     ...
     * @param provider the capacity provider to add to this cluster.
     */
    addManagedInstancesCapacityProvider(provider: ManagedInstancesCapacityProvider): void;
 ...
 */
export declare enum InstanceMonitoring {
    /**
 ...
 */
export declare enum PropagateManagedInstancesTags {
    /**
 ...
 */
export declare class ManagedInstancesCapacityProvider extends Construct implements ec2.IConnectable {
    /**
     * Uniquely identifies this class.
     */
    static readonly PROPERTY_INJECTION_ID: string;
     ...
     * The cluster this capacity provider is associated with
     */
    get cluster(): ICluster | undefined;
     ...
     * @see https://docs.aws.amazon.com/AmazonECS/latest/developerguide/managed-instances-instance-profile.html
     */
    private createDefaultInstanceProfile;
    /**
