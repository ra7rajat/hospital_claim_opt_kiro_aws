...
import { AccessPolicyReference, AssetModelReference, AssetReference, ComputationModelReference, DashboardReference, DatasetReference, GatewayReference, IAccessPolicyRef, IAssetModelRef, IAssetRef, IComputationModelRef, IDashboardRef, IDatasetRef, IGatewayRef, IPortalRef, IProjectRef, PortalReference, ProjectReference } from "../../interfaces/generated/aws-iotsitewise-interfaces.generated";
import { aws_iotsitewise as ioTSiteWiseRefs } from "../../interfaces";
/**
...
export declare class CfnAccessPolicy extends cdk.CfnResource implements cdk.IInspectable, IAccessPolicyRef {
     ...
     */
    static fromAccessPolicyArn(scope: constructs.Construct, id: string, arn: string): IAccessPolicyRef;
    /**
     * Creates a new IAccessPolicyRef from a accessPolicyId
     */
    static fromAccessPolicyId(scope: constructs.Construct, id: string, accessPolicyId: string): IAccessPolicyRef;
    static arnForAccessPolicy(resource: IAccessPolicyRef): string;
    /**
...
export declare class CfnAsset extends cdk.CfnResource implements cdk.IInspectable, IAssetRef, cdk.ITaggable {
     ...
     */
    static fromAssetArn(scope: constructs.Construct, id: string, arn: string): IAssetRef;
    /**
     * Creates a new IAssetRef from a assetId
     */
    static fromAssetId(scope: constructs.Construct, id: string, assetId: string): IAssetRef;
...
export interface CfnAssetProps {
     ...
     */
    readonly assetModelId: ioTSiteWiseRefs.IAssetModelRef | string;
    /**
     * A friendly name for the asset.
     *
 ...
 */
export declare class CfnAssetModel extends cdk.CfnResource implements cdk.IInspectable, IAssetModelRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnAssetModel(x: any): x is CfnAssetModel;
    /**
     * Creates a new IAssetModelRef from an ARN
     */
    static fromAssetModelArn(scope: constructs.Construct, id: string, arn: string): IAssetModelRef;
    /**
     * Creates a new IAssetModelRef from a assetModelId
     */
    static fromAssetModelId(scope: constructs.Construct, id: string, assetModelId: string): IAssetModelRef;
    static arnForAssetModel(resource: IAssetModelRef): string;
    /**
    ...
    get assetModelRef(): AssetModelReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnDashboard extends cdk.CfnResource implements cdk.IInspectable, IDashboardRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDashboard(x: any): x is CfnDashboard;
    /**
     * Creates a new IDashboardRef from an ARN
     */
    static fromDashboardArn(scope: constructs.Construct, id: string, arn: string): IDashboardRef;
    /**
     * Creates a new IDashboardRef from a dashboardId
     */
    static fromDashboardId(scope: constructs.Construct, id: string, dashboardId: string): IDashboardRef;
    static arnForDashboard(resource: IDashboardRef): string;
    /**
 ...
 */
export declare class CfnGateway extends cdk.CfnResource implements cdk.IInspectable, IGatewayRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static fromGatewayId(scope: constructs.Construct, id: string, gatewayId: string): IGatewayRef;
 ...
 */
export declare class CfnPortal extends cdk.CfnResource implements cdk.IInspectable, IPortalRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnPortal(x: any): x is CfnPortal;
    /**
     * Creates a new IPortalRef from an ARN
     */
    static fromPortalArn(scope: constructs.Construct, id: string, arn: string): IPortalRef;
    /**
     * Creates a new IPortalRef from a portalId
     */
    static fromPortalId(scope: constructs.Construct, id: string, portalId: string): IPortalRef;
    static arnForPortal(resource: IPortalRef): string;
    /**
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef, cdk.ITaggable {
     ...
     */
    static fromProjectId(scope: constructs.Construct, id: string, projectId: string): IProjectRef;
 ...
 */
export declare class CfnComputationModel extends cdk.CfnResource implements cdk.IInspectable, IComputationModelRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnComputationModel(x: any): x is CfnComputationModel;
    /**
     * Creates a new IComputationModelRef from an ARN
     */
    static fromComputationModelArn(scope: constructs.Construct, id: string, arn: string): IComputationModelRef;
    /**
     * Creates a new IComputationModelRef from a computationModelId
     */
    static fromComputationModelId(scope: constructs.Construct, id: string, computationModelId: string): IComputationModelRef;
    static arnForComputationModel(resource: IComputationModelRef): string;
    /**
    ...
    get computationModelRef(): ComputationModelReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static fromDatasetArn(scope: constructs.Construct, id: string, arn: string): IDatasetRef;
    /**
     * Creates a new IDatasetRef from a datasetId
     */
    static fromDatasetId(scope: constructs.Construct, id: string, datasetId: string): IDatasetRef;
...
export type { IAssetRef, AssetReference };
export type { IAssetModelRef, AssetModelReference };
export type { IDashboardRef, DashboardReference };
export type { IGatewayRef, GatewayReference };
export type { IPortalRef, PortalReference };
export type { IProjectRef, ProjectReference };
export type { IComputationModelRef, ComputationModelReference };
