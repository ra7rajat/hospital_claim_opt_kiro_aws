...
import { DomainReference, IDomainRef } from './opensearchservice.generated';
...
export declare class Domain extends DomainBase implements IDomain, ec2.IConnectable {
     ...
     * @attribute
     */
    get slowSearchLogGroup(): logs.ILogGroup | undefined;
    /**
     * Log group that slow indices are logged to.
     *
     * @attribute
     */
    get slowIndexLogGroup(): logs.ILogGroup | undefined;
    /**
     * Log group that application logs are logged to.
     *
     * @attribute
     */
    get appLogGroup(): logs.ILogGroup | undefined;
    /**
     * Log group that audit logs are logged to.
     *
     * @attribute
     */
    get auditLogGroup(): logs.ILogGroup | undefined;
    /**
     * Master user password if fine grained access control is configured.
     */
    readonly masterUserPassword?: cdk.SecretValue;
    private readonly _slowSearchLogGroup?;
    private readonly _slowIndexLogGroup?;
    private readonly _appLogGroup?;
    private readonly _auditLogGroup?;
     ...
     */
    private selectKmsKeyIdentifier;
}
export {};
