...
import { ClusterReference, IClusterRef, IInstanceFleetConfigRef, IInstanceGroupConfigRef, InstanceFleetConfigReference, InstanceGroupConfigReference, ISecurityConfigurationRef, IStepRef, IStudioRef, IStudioSessionMappingRef, IWALWorkspaceRef, SecurityConfigurationReference, StepReference, StudioReference, StudioSessionMappingReference, WALWorkspaceReference } from "../../interfaces/generated/aws-emr-interfaces.generated";
import { aws_ec2 as ec2Refs, aws_emr as emrRefs, aws_iam as iamRefs, aws_kms as kmsRefs, aws_s3 as s3Refs } from "../../interfaces";
/**
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggable {
     ...
     */
    static fromClusterId(scope: constructs.Construct, id: string, clusterId: string): IClusterRef;
...
export declare class CfnInstanceFleetConfig extends cdk.CfnResource implements cdk.IInspectable, IInstanceFleetConfigRef {
     ...
     */
    static isCfnInstanceFleetConfig(x: any): x is CfnInstanceFleetConfig;
    /**
     * @cloudformationAttribute Id
     */
    readonly attrId: string;
...
export declare class CfnInstanceGroupConfig extends cdk.CfnResource implements cdk.IInspectable, IInstanceGroupConfigRef {
     ...
     */
    static isCfnInstanceGroupConfig(x: any): x is CfnInstanceGroupConfig;
    /**
     * @cloudformationAttribute Id
     */
    readonly attrId: string;
...
export declare class CfnStep extends cdk.CfnResource implements cdk.IInspectable, IStepRef {
     ...
     */
    static isCfnStep(x: any): x is CfnStep;
    /**
...
export declare class CfnStudio extends cdk.CfnResource implements cdk.IInspectable, IStudioRef, cdk.ITaggable {
     ...
     */
    static fromStudioArn(scope: constructs.Construct, id: string, arn: string): IStudioRef;
    /**
...
export interface CfnStudioProps {
     ...
     */
    readonly defaultS3Location: s3Refs.IBucketRef | string;
    /**
     * A detailed description of the Amazon EMR Studio.
     *
     ...
     */
    readonly encryptionKeyArn?: kmsRefs.IKeyRef | string;
    /**
     * The ID of the Amazon EMR Studio Engine security group.
     *
     ...
     */
    readonly engineSecurityGroupId: ec2Refs.ISecurityGroupRef | string;
    /**
     * The ARN of the IAM Identity Center instance the Studio application belongs to.
     *
     ...
     */
    readonly serviceRole: iamRefs.IRoleRef | string;
    /**
     * A list of subnet IDs to associate with the Amazon EMR Studio.
     *
     ...
     */
    readonly userRole?: iamRefs.IRoleRef | string;
    /**
     * The ID of the Amazon Virtual Private Cloud (Amazon VPC) to associate with the Studio.
     *
     ...
     */
    readonly workspaceSecurityGroupId: ec2Refs.ISecurityGroupRef | string;
}
/**
...
export declare class CfnStudioSessionMapping extends cdk.CfnResource implements cdk.IInspectable, IStudioSessionMappingRef {
     ...
     */
    static isCfnStudioSessionMapping(x: any): x is CfnStudioSessionMapping;
    /**
...
export interface CfnStudioSessionMappingProps {
     ...
     */
    readonly sessionPolicyArn: iamRefs.IManagedPolicyRef | string;
    /**
     * The ID of the Amazon EMR Studio to which the user or group will be mapped.
     *
     ...
     */
    readonly studioId: emrRefs.IStudioRef | string;
}
/**
...
export declare class CfnWALWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWALWorkspaceRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnWALWorkspace(x: any): x is CfnWALWorkspace;
    /**
     * Tag Manager which manages the tags for this resource
     */
...
export type { IInstanceFleetConfigRef, InstanceFleetConfigReference };
export type { IInstanceGroupConfigRef, InstanceGroupConfigReference };
export type { ISecurityConfigurationRef, SecurityConfigurationReference };
export type { IStepRef, StepReference };
export type { IStudioRef, StudioReference };
export type { IStudioSessionMappingRef, StudioSessionMappingReference };
export type { IWALWorkspaceRef, WALWorkspaceReference };
