...
import { CidrCollectionReference, DNSSECReference, HealthCheckReference, HostedZoneReference, ICidrCollectionRef, IDNSSECRef, IHealthCheckRef, IHostedZoneRef, IKeySigningKeyRef, IRecordSetGroupRef, IRecordSetRef, KeySigningKeyReference, RecordSetGroupReference, RecordSetReference } from "../../interfaces/generated/aws-route53-interfaces.generated";
/**
...
export declare class CfnCidrCollection extends cdk.CfnResource implements cdk.IInspectable, ICidrCollectionRef {
     ...
     */
    static isCfnCidrCollection(x: any): x is CfnCidrCollection;
    static arnForCidrCollection(resource: ICidrCollectionRef): string;
    /**
...
export declare class CfnDNSSEC extends cdk.CfnResource implements cdk.IInspectable, IDNSSECRef {
     ...
     */
    static isCfnDNSSEC(x: any): x is CfnDNSSEC;
    /**
...
export declare class CfnHealthCheck extends cdk.CfnResource implements cdk.IInspectable, IHealthCheckRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnHealthCheck(x: any): x is CfnHealthCheck;
    static arnForHealthCheck(resource: IHealthCheckRef): string;
    /**
...
export declare class CfnHostedZone extends cdk.CfnResource implements cdk.IInspectable, IHostedZoneRef, cdk.ITaggable {
     ...
     */
    static isCfnHostedZone(x: any): x is CfnHostedZone;
    static arnForHostedZone(resource: IHostedZoneRef): string;
    /**
     ...
     */
    hostedZoneFeatures?: CfnHostedZone.HostedZoneFeaturesProperty | cdk.IResolvable;
    /**
...
export declare namespace CfnHostedZone {
    ...
    interface HostedZoneFeaturesProperty {
         ...
         */
        readonly enableAcceleratedRecovery?: boolean | cdk.IResolvable;
    }
}
/**
...
export interface CfnHostedZoneProps {
     ...
     */
    readonly hostedZoneFeatures?: CfnHostedZone.HostedZoneFeaturesProperty | cdk.IResolvable;
    /**
     * Adds, edits, or deletes tags for a health check or a hosted zone.
     *
...
export declare class CfnKeySigningKey extends cdk.CfnResource implements cdk.IInspectable, IKeySigningKeyRef {
     ...
     */
    static isCfnKeySigningKey(x: any): x is CfnKeySigningKey;
    /**
...
export declare class CfnRecordSet extends cdk.CfnResource implements cdk.IInspectable, IRecordSetRef {
     ...
     */
    static isCfnRecordSet(x: any): x is CfnRecordSet;
    /**
...
export declare class CfnRecordSetGroup extends cdk.CfnResource implements cdk.IInspectable, IRecordSetGroupRef {
     ...
     */
    static isCfnRecordSetGroup(x: any): x is CfnRecordSetGroup;
    /**
     * This element contains an ID that you use when performing a `GetChange` action to get detailed information about the change.
     *
     * @cloudformationAttribute Id
...
export type { ICidrCollectionRef, CidrCollectionReference };
export type { IDNSSECRef, DNSSECReference };
export type { IHealthCheckRef, HealthCheckReference };
export type { IHostedZoneRef, HostedZoneReference };
export type { IKeySigningKeyRef, KeySigningKeyReference };
export type { IRecordSetRef, RecordSetReference };
export type { IRecordSetGroupRef, RecordSetGroupReference };
